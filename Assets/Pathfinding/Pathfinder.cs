...
public class Pathfinder : MonoBehaviour
{
    ...
    [SerializeField] Vector2Int desinationCoords;
    public Vector2Int DestinationCoords { get { return desinationCoords; } }
   ...
   Vector2Int[] directions = { Vector2Int.right, Vector2Int.left, Vector2Int.up, Vector2Int.down };
    ...
    void Awake()
    {
        ...
        if(gridManager != null)
        {
            ...
            destinationNode = grid[desinationCoords];
        } 
    }
    ...
    void BreadthFirstSearch(Vector2Int coordinates)
    {
        ...
        while(frontier.Count > 0 && isRunning)
        {
            ...
            ExploreNeighbours();
            if(currentSearchNode.coordinates == desinationCoords)
            {
                isRunning = false;
            }
        }
